---
title: "Logistic regression interpreted"
author: "Gerko Vink"
...
- Sensitivity is calculated as $\text{Sensitivity} = A/(A+C) = \frac{242}{100+242} =$ `r 242/(242+100)`
  - Sensitivity is the proportion of actual `not Survived` that have been correctly predicted as `Survived`. 
  - Sensitivity is the *True Positive Rate*
  
- Specificity is calculated as $\text{Specificity} = D/(B+D) = \frac{463}{463+82} =$ `r 463/(463+82)`
