...
### Materials
Ik pas mijn onderwijs meestal aan de doelgroep aan. Daardoor kunnen onderwijsmaterialen soms zelfs gedurende de dag kunnen veranderen of uitgebreid worden. Om er zeker van te zijn dat je de laatste iteratie van de cursusmaterialen hebt, adviseer ik om de materialen online te bekijken. 
...
Alle collegeslides zijn in `html` format. Practicals zijn *walkthrough files* die je door de oefeningen heen helpen.  
...
Zie ook [this `rmarkdown` cheat sheet](Contents/Day 1/rmarkdown-reference_sheet.pdf). 